<svg aria-hidden="true" class="transition-transform transform rotate-[var(--rotate,0deg)] fill-[var(--text-color,currentColor)]" focusable="false" preserveAspectRatio="xMidYMid meet" style="width: 32px; height: 32px; overflow: visible;" viewBox="0 0 24 24">
